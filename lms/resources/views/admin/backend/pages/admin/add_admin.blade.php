        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="{{ route('store.admin') }}" method="post" class="row g-3"
                    ...
                    <div class="form-group col-md-6">
                        <label for="input6" class="form-label">Admin Password</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="input7" class="form-label">Role Name</label>
                        <select name="roles" class="form-select mb-3 @error('roles') is-invalid @enderror"
                            aria-label="Default select example" id="input7">
