            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-box mt-20px">
                            <a href="{{ route('login') }}" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="la la-file-text-o mr-1"></i>Start Learning</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Algo Oasis for Business</h5>
                        <p class="card-text">Get unlimited access to 5,000+ of Algo Oasis's top courses for your team</p>
                        <div class="btn-box mt-20px">
                            <a href="{{ url('/') }}" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="la la-briefcase mr-1"></i>Get Algo Oasis for Business</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
