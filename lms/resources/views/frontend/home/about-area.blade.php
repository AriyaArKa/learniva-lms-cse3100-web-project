@php
    ...
    $totalCourses = App\Models\Course::where('status', '1')->count();
    $totalInstructors = App\Models\User::where('role', 'instructor')->where('status', '1')->count();
            ...
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Benefits of Learning With {{ config('app.name', 'Algo Oasis') }}</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc">
                            Join thousands of students worldwide in our comprehensive learning platform.
                            We offer quality education with expert instructors, interactive courses, and
                            a supportive community to help you achieve your learning goals.
                        </p>
